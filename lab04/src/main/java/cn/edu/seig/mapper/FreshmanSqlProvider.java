...
public class FreshmanSqlProvider {
    ...
    public String getFreshmanById(final Map<String, Object> param) {
        return new SQL() {
            {
                SELECT("*");
                FROM("tb_freshman");
    ...
    public String selectFreshmanByMultiple(final Map<String, Object> param) {
        String sql=new SQL() {
            {
                SELECT("*");
                FROM("tb_freshman");
    ...
    public String addFreshman(final Freshman f) {
        String sql=new SQL() {
            {
    ...
    public String updateFreshman(final Freshman f) {
        String sql=new SQL() {
            {
                UPDATE("tb_freshman");
                if (f.getSex() != 0) {
    ...
    public String deleteFreshman(final Map<String, Object> param) {
        return new SQL() {
            {
