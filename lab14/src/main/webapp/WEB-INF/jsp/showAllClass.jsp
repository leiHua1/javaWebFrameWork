                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <a href="${baseurl}/toAddClass" class="btn btn-info btn-gradient pull-right"><span
                                    class="glyphicons glyphicon-plus"></span> 添加班级</a>
                        </div>
                        <form action="" method="post">
                            <div class="panel-body">
                                <table class="table table-striped table-bordered table-hover dataTable">
                                    ...
                                    <c:forEach items="${classList}" var="clazz" varStatus="s">
                                        <tr class="success">
                                            ...
                                            <td>${clazz.classSize}</td>
                                            <td>${clazz.classSurplus}</td>
                                            <td>${clazz.tutorId}</td>
                                            <td>${clazz.instructorId}</td>
                                            <td>
                                                <div class="btn-group">
                                                    <a href="toEditClass?classId=${clazz.classId}">修改</a>
                                                    <a href="deleteClass?classId=${clazz.classId}">删除</a></div>
                                            </td>
                                        </tr>
                                    </c:forEach>
