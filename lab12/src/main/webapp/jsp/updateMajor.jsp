...
<form action="updateMajor" method="post">
    <div id="table_div">
        <table align="center">
            <tr >
                <td>专业ID：</td>
                <td><input type="text" name="majorId" value="${major.majorId}" /></td>
            </tr>
            <tr >
                <td>专业名称：</td>
                <td>
                    <input type="text" name="majorName" value="${major.majorName}"/></td>
            </tr>
            <tr >
                <td>专业学费：</td>
                <td>
                    <input type="text" name="tuition"  value="${major.tuition}"/></td>
            </tr>
            <tr align="center">
